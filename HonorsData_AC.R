...
InputData <- read.csv("/Users/carolinelee/Desktop/Honors/Undergrad/72_undergrad_s96.csv")

consent_1 <- as.character(InputData[1, "response"]) == "c"  

consent_2 <- as.character(InputData[3, "response"]) == "b"  

consent_correct <- ifelse(consent_1 == TRUE & consent_2 == TRUE, TRUE, FALSE) 

# ===================================== RunID

run_id <- InputData[1, "run_id"]
...
condition <- as.character(InputData[1, "condition"])

# ===================================== UserID 

assigned_userid <- str_sub(as.character(InputData[6, "response"]), 8, -3)

created_userid <- str_sub(as.character(InputData[7, "response"]), 8, -3)

prolific_id <- NA 

# ===================================== Age 

age <- str_sub(as.character(InputData[8, "response"]), 9, -3)

age <- as.numeric(age)

# ===================================== Gender 

gender <- as.character(InputData[9, "response"])
...
race_ethnicity <- as.character(InputData[10, "response"])
...
SAM_valence_pre <- as.numeric(as.character(InputData[12, "response"]))

SAM_arousal_pre <- as.numeric(as.character(InputData[13, "response"]))

SAM_valence_post <- as.numeric(as.character(InputData[15, "response"]))

SAM_arousal_post <- as.numeric(as.character(InputData[16, "response"]))

# ===================================== FERT Emotion Recognition
# Scoring procedure and code by Passarelli, M., Masini, M., Bracco, F., Petrosino, M., & Chiorri, C. (2018).  
...
FERT_CorrectEstimate <- as.numeric(as.character(InputData[54, "response"])) / 100

# ===================================== Attention Check

attention_check <- as.numeric(as.character(InputData[58, "response"]))
...
R1_Strategy <- ifelse(as.character(InputData[65, "response"]) == "g", "Cooperate", "Defect")

R1_Outcome <- as.character(InputData[69, "stimulus"])

R1_Outcome <- toupper(str_sub(R1_Outcome, 62, -33))

R1_AffectiveFeedback <- as.numeric(as.character(InputData[69, "response"]))
...
R1_CoopExpect <- as.numeric(as.character(InputData[71, "response"])) / 100

# Round 2 

R2_Strategy <- ifelse(as.character(InputData[72, "response"]) == "g", "Cooperate", "Defect")

R2_Outcome <- as.character(InputData[75, "stimulus"])

R2_Outcome <- toupper(str_sub(R2_Outcome, 62, -33))

R2_AffectiveFeedback <- as.numeric(as.character(InputData[75, "response"]))
...
R2_CoopExpect <- as.numeric(as.character(InputData[77, "response"])) / 100

# Round 3

R3_Strategy <- ifelse(as.character(InputData[78, "response"]) == "g", "Cooperate", "Defect")

R3_Outcome <- as.character(InputData[81, "stimulus"])

R3_Outcome <- toupper(str_sub(R3_Outcome, 62, -33))

R3_AffectiveFeedback <- as.numeric(as.character(InputData[81, "response"]))
...
R3_CoopExpect <- as.numeric(as.character(InputData[83, "response"])) / 100

# Round 4

R4_Strategy <- ifelse(as.character(InputData[84, "response"]) == "g", "Cooperate", "Defect")

R4_Outcome <- as.character(InputData[87, "stimulus"])

R4_Outcome <- toupper(str_sub(R4_Outcome, 62, -33))

R4_AffectiveFeedback <- as.numeric(as.character(InputData[87, "response"]))
...
R4_CoopExpect <- as.numeric(as.character(InputData[89, "response"])) / 100

# Round 5 

R5_Strategy <- ifelse(as.character(InputData[90, "response"]) == "g", "Cooperate", "Defect")

R5_Outcome <- as.character(InputData[93, "stimulus"])

R5_Outcome <- toupper(str_sub(R5_Outcome, 62, -33))

R5_AffectiveFeedback <- as.numeric(as.character(InputData[93, "response"]))
...
R5_CoopExpect <- as.numeric(as.character(InputData[95, "response"])) / 100

# Round 6

R6_Strategy <- ifelse(as.character(InputData[96, "response"]) == "g", "Cooperate", "Defect")

R6_Outcome <- as.character(InputData[99, "stimulus"])

R6_Outcome <- toupper(str_sub(R6_Outcome, 62, -33))

R6_AffectiveFeedback <- as.numeric(as.character(InputData[99, "response"]))
...
R6_CoopExpect <- as.numeric(as.character(InputData[101, "response"])) / 100

# Round 7 

R7_Strategy <- ifelse(as.character(InputData[102, "response"]) == "g", "Cooperate", "Defect")

R7_Outcome <- as.character(InputData[105, "stimulus"])

R7_Outcome <- toupper(str_sub(R7_Outcome, 62, -33))

R7_AffectiveFeedback <- as.numeric(as.character(InputData[105, "response"]))
...
R7_CoopExpect <- as.numeric(as.character(InputData[107, "response"])) / 100

# Round 8 

R8_Strategy <- ifelse(as.character(InputData[108, "response"]) == "g", "Cooperate", "Defect")

R8_Outcome <- as.character(InputData[111, "stimulus"])

R8_Outcome <- toupper(str_sub(R8_Outcome, 62, -33))

R8_AffectiveFeedback <- as.numeric(as.character(InputData[111, "response"]))
...
R8_CoopExpect <- as.numeric(as.character(InputData[113, "response"])) / 100

# Round 9 

R9_Strategy <- ifelse(as.character(InputData[114, "response"]) == "g", "Cooperate", "Defect")

R9_Outcome <- as.character(InputData[117, "stimulus"])

R9_Outcome <- toupper(str_sub(R9_Outcome, 62, -33))

R9_AffectiveFeedback <- as.numeric(as.character(InputData[117, "response"]))
...
R9_CoopExpect <- as.numeric(as.character(InputData[119, "response"])) / 100

# Round 10 

R10_Strategy <- ifelse(as.character(InputData[120, "response"]) == "g", "Cooperate", "Defect")

R10_Outcome <- as.character(InputData[123, "stimulus"])

R10_Outcome <- toupper(str_sub(R10_Outcome, 62, -33))

R10_AffectiveFeedback <- as.numeric(as.character(InputData[123, "response"]))
...
R10_CoopExpect <- as.numeric(as.character(InputData[125, "response"])) / 100

# Round 11 

R11_Strategy <- ifelse(as.character(InputData[126, "response"]) == "g", "Cooperate", "Defect")

R11_Outcome <- as.character(InputData[129, "stimulus"])

R11_Outcome <- toupper(str_sub(R11_Outcome, 62, -33))

R11_AffectiveFeedback <- as.numeric(as.character(InputData[129, "response"]))
...
R11_CoopExpect <- as.numeric(as.character(InputData[131, "response"])) / 100

# Round 12

R12_Strategy <- ifelse(as.character(InputData[132, "response"]) == "g", "Cooperate", "Defect")

R12_Outcome <- as.character(InputData[135, "stimulus"])

R12_Outcome <- toupper(str_sub(R12_Outcome, 62, -33))

R12_AffectiveFeedback <- as.numeric(as.character(InputData[135, "response"]))
...
R12_CoopExpect <- as.numeric(as.character(InputData[137, "response"])) / 100

# Round 13

R13_Strategy <- ifelse(as.character(InputData[138, "response"]) == "g", "Cooperate", "Defect")

R13_Outcome <- as.character(InputData[141, "stimulus"])

R13_Outcome <- toupper(str_sub(R13_Outcome, 62, -33))

R13_AffectiveFeedback <- as.numeric(as.character(InputData[141, "response"]))
...
R13_CoopExpect <- as.numeric(as.character(InputData[143, "response"])) / 100

# Round 14

R14_Strategy <- ifelse(as.character(InputData[144, "response"]) == "g", "Cooperate", "Defect")

R14_Outcome <- as.character(InputData[147, "stimulus"])

R14_Outcome <- toupper(str_sub(R14_Outcome, 62, -33))

R14_AffectiveFeedback <- as.numeric(as.character(InputData[147, "response"]))
...
R14_CoopExpect <- as.numeric(as.character(InputData[149, "response"])) / 100

# Round 15

R15_Strategy <- ifelse(as.character(InputData[150, "response"]) == "g", "Cooperate", "Defect")

R15_Outcome <- as.character(InputData[153, "stimulus"])

R15_Outcome <- toupper(str_sub(R15_Outcome, 62, -33))

R15_AffectiveFeedback <- as.numeric(as.character(InputData[153, "response"]))
...
R15_CoopExpect <- as.numeric(as.character(InputData[155, "response"])) / 100

# Round 16

R16_Strategy <- ifelse(as.character(InputData[156, "response"]) == "g", "Cooperate", "Defect")

R16_Outcome <- as.character(InputData[159, "stimulus"])

R16_Outcome <- toupper(str_sub(R16_Outcome, 62, -33))

R16_AffectiveFeedback <- as.numeric(as.character(InputData[159, "response"]))
...
R16_CoopExpect <- as.numeric(as.character(InputData[161, "response"])) / 100

# Round 17 

R17_Strategy <- ifelse(as.character(InputData[162, "response"]) == "g", "Cooperate", "Defect")

R17_Outcome <- as.character(InputData[165, "stimulus"])

R17_Outcome <- toupper(str_sub(R17_Outcome, 62, -33))

R17_AffectiveFeedback <- as.numeric(as.character(InputData[165, "response"]))
...
R17_CoopExpect <- as.numeric(as.character(InputData[167, "response"])) / 100

# Round 18 

R18_Strategy <- ifelse(as.character(InputData[168, "response"]) == "g", "Cooperate", "Defect")

R18_Outcome <- as.character(InputData[171, "stimulus"])

R18_Outcome <- toupper(str_sub(R18_Outcome, 62, -33))

R18_AffectiveFeedback <- as.numeric(as.character(InputData[171, "response"]))
...
R18_CoopExpect <- as.numeric(as.character(InputData[173, "response"])) / 100

# Round 19

R19_Strategy <- ifelse(as.character(InputData[174, "response"]) == "g", "Cooperate", "Defect")

R19_Outcome <- as.character(InputData[177, "stimulus"])

R19_Outcome <- toupper(str_sub(R19_Outcome, 62, -33))

R19_AffectiveFeedback <- as.numeric(as.character(InputData[177, "response"]))
...
R19_CoopExpect <- as.numeric(as.character(InputData[179, "response"])) / 100

# Round 20 

R20_Strategy <- ifelse(as.character(InputData[180, "response"]) == "g", "Cooperate", "Defect")

R20_Outcome <- as.character(InputData[183, "stimulus"])

R20_Outcome <- toupper(str_sub(R20_Outcome, 62, -33))

R20_AffectiveFeedback <- as.numeric(as.character(InputData[183, "response"]))
...
PPI <- as.character(InputData[185, "response"])
...
assign(paste0("undergrad_", run_id), data.frame(sample, condition, assigned_userid, created_userid, prolific_id, age, gender, race_ethnicity, SAM_valence_pre, SAM_arousal_pre, 
                                                SAM_valence_post, SAM_arousal_post, FERT_Score, FERT_CorrectEstimate, attention_check, R1_Strategy, R1_Outcome, R1_AffectiveFeedback, R1_CoopExpect, 
                                                ...
                                                R20_Strategy, R20_Outcome, R20_AffectiveFeedback, IPD_Score, PPIR_ME, PPIR_SOI, PPIR_F, PPIR_RN, PPIR_C, PPIR_STI, PPIR_CN, PPIR_BE,
                                                PPIR_TOTAL, PPIR_SCImp, PPIR_FearDom))
